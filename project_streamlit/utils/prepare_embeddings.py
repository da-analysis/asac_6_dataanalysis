from vanna_model import VannaModelManager
import pandas as pd
import os
import json
...
def prepare_embeddings():
    ...
    try:
        ...
        config["vector_store_name"] = "normal_chatbot_chromadb"  # 🔹 폴더 이름만 변경
        ...
        SELECT
            `질문` AS question,
            `쿼리` AS query
        FROM gold.normal_chatbot_qq_mapping.qq_mapping_table
        """
