...
# API 정보
url = "http://apis.data.go.kr/B190001/paperSale/sale"
service_key = dbutils.secrets.get(scope="asac_6", key="datago")
catalog_table = "bronze.api_public.komsco_sale_paper"
...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM bronze.api_public.komsco_sale_paper
...
# MAGIC SELECT COUNT(*)
# MAGIC FROM(
# MAGIC SELECT DISTINCT(*) FROM bronze.api_public.komsco_sale_paper
# MAGIC ORDER BY id);
...
# MAGIC %sql
# MAGIC ALTER TABLE bronze.api_public.komsco_sale_paper
...
# MAGIC
# MAGIC ALTER TABLE bronze.api_public.komsco_sale_paper
# MAGIC ALTER COLUMN ntsl_yn COMMENT '판매여부(Y/N)';
# MAGIC
# MAGIC ALTER TABLE bronze.api_public.komsco_sale_paper
