...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM bronze.api_public.`한국조폐공사_지역사랑상품권_지류_판매지점정보_전국`
...
# MAGIC SELECT COUNT(*)
# MAGIC FROM(
# MAGIC SELECT DISTINCT(*) FROM bronze.api_public.`한국조폐공사_지역사랑상품권_지류_판매지점정보_전국`
# MAGIC ORDER BY id);
...
# MAGIC %sql
# MAGIC ALTER TABLE bronze.api_public.`한국조폐공사_지역사랑상품권_지류_판매지점정보_전국`
